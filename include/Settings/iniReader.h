...
class INIReader {
    ...
    public:
        ...
        /* Once I learn how to make a specialized template I can get rid of this function */
        string extractString(const string& section, const string& key);
...
T INIReader::extractValue(const string& section, const string& key) {
    istringstream ss( getKeyValue(section, key) );
